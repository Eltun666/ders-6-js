...
// const height = () => {
//     let heightarrey = users.filter((persone) => persone.height > 150)
//     console.log(heightarrey);
// }
// height()
...
let firstname = prompt("Adi daxil edin")

const person = (firstname) => {
    let personInformation = users.filter((person) => person.firstName == firstname )
...
//     console.log((totalage / users.length) | 0);
// }
...
// const title = () => {
//     let title = users.map((item) => item.company.title == "Web Developer")
//     console.log(title);
// }
// title()